...
var googleProfileUserLoader = (function() {
  ...
  var signin_button, revoke_button, user_info_div;
 ...
 function disableButton(button) {
  ...
  function changeState(newState) {
    ...
    switch (state) {
      case STATE_START:
        ...
        document.getElementById("profile_photo").setAttribute('hidden','hidden');
        break;
      ...
      case STATE_AUTHTOKEN_ACQUIRED:
        ...
        document.getElementById("account").setAttribute('hidden','hidden');
        document.getElementById("profile_photo").removeAttribute('hidden');
        break;
    }
  }
  ...
  function onImageFetched(e) {
    ...
    // login_username.insertAdjacentElement("afterbegin", imgElem);
  }
  ...
  **/
  ...
  function interactiveSignIn() {
    ...
    chrome.identity.getAuthToken({ 'interactive': true }, function(token) {
      if (chrome.runtime.lastError) {
        ...
        changeState(STATE_AUTHTOKEN_ACQUIRED);
        // Start Fetching the UserName and ProfilePhoto
    getUserInfo(true);
  ...
  return {
    onload: function () {
      signin_button = document.querySelector('#gmailbtn');
      ...
      // login_username= document.getElementById('login_user_name');
      user_info_div = document.querySelector('#profile_photo');
